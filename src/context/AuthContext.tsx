        ...
        if (token || stored) {
          ...
          if (profileData) {
            ...
            const updated: User = {
              ...
              avatar: resolveImageUrl(profileData.profileImage || profileData.avatar || profileData.profile?.profileImage || tokenPayload?.picture || parsedUser?.avatar),
              profileImage: resolveImageUrl(profileData.profileImage || profileData.avatar || profileData.profile?.profileImage || tokenPayload?.picture || parsedUser?.profileImage),
  ...
  const login = async (email: string, password: string): Promise<{ success: boolean; user?: User; error?: string }> => {
    ...
    try {
      ...
      let loggedInUser: User = {
        ...
        avatar: resolveImageUrl(userPayload.profileImage || userPayload.avatar || userPayload.profile?.profileImage || null),
        profileImage: resolveImageUrl(userPayload.profileImage || userPayload.avatar || userPayload.profile?.profileImage || null),
      ...
      try {
        ...
        if (fullProfile) {
          ...
          loggedInUser = {
            ...
            ...fullProfile,
            name: mergedName,
            avatar: resolveImageUrl(fullProfile.profileImage || fullProfile.avatar || fullProfile.profile?.profileImage || loggedInUser.avatar),
            profileImage: resolveImageUrl(fullProfile.profileImage || fullProfile.avatar || fullProfile.profile?.profileImage || loggedInUser.profileImage),
            streakDays: pStreak,
      ...
      if (profileData) {
        setUser((prev) => {
          ...
          const updated: User = {
            ...
            avatar: resolveImageUrl(profileData.profileImage || profileData.avatar || profileData.profile?.profileImage || prev?.avatar),
            profileImage: resolveImageUrl(profileData.profileImage || profileData.avatar || profileData.profile?.profileImage || prev?.profileImage),
            bio: profileData.bio || null,
            phoneNumber: profileData.phoneNumber || null,
            country: profileData.country || null,
            timezone: profileData.timezone || null,
