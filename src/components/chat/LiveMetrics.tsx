  ...
  return (
    <div className="bg-paper-card border border-slate-200 dark:border-white/10 rounded-2xl p-4 shadow-sm space-y-4 text-ink">
      <div className="flex items-center justify-between border-b border-slate-200 dark:border-white/10 pb-3">
        ...
        <span className="text-[11px] font-semibold text-primary dark:text-purple-300 bg-primary/10 dark:bg-purple-500/20 border border-primary/20 dark:border-purple-500/30 px-2 py-0.5 rounded-md">
          {activeLevel}
        </span>
      </div>

      <div className="grid grid-cols-3 gap-3 text-center">
        <div className="p-2.5 rounded-xl bg-slate-50 dark:bg-[#070510]/60 border border-slate-200/60 dark:border-white/5">
        ...
        <div className="p-2.5 rounded-xl bg-slate-50 dark:bg-[#070510]/60 border border-slate-200/60 dark:border-white/5">
          ...
          <span className="text-lg font-bold text-primary dark:text-purple-300">+{vocabXP}</span>
        </div>
      </div>
      ...
      <div className="space-y-1.5 pt-1">
        <div className="flex justify-between text-[11px] font-medium text-ink-soft">
          ...
          <span className="font-bold text-primary dark:text-purple-300">High (C1-C2)</span>
        </div>
        <div className="w-full h-2 bg-slate-200 dark:bg-white/10 rounded-full overflow-hidden">
          <div className="h-full bg-gradient-to-r from-purple-600 to-fuchsia-400 rounded-full transition-all duration-500" style={{ width: "82%" }} />
        </div>
      </div>
    </div>
  );
