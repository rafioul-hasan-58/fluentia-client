...
export function GoogleAuthButton({
  ...
  return (
    <Button
      ...
      className={cn(
        "w-full h-11 border-slate-200 dark:border-white/10 hover:border-primary/50 text-xs sm:text-sm font-semibold flex items-center justify-center gap-3 shadow-xs bg-paper",
        className
      )}
    >
      {isLoading ? (
