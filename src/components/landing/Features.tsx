      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 relative z-10 space-y-12 sm:space-y-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 sm:gap-6 relative">
          {LEARNING_STEPS.map((step, idx) => {
            ...
            // Flow arrow connection conditions across breakpoints:
            // Desktop 3-col: 01->02 (idx 0), 02->03 (idx 1), 04->05 (idx 3), 05->06 (idx 4)
            const showLgArrow = idx === 0 || idx === 1 || idx === 3 || idx === 4;
            // Tablet 2-col: 01->02 (idx 0), 03->04 (idx 2), 05->06 (idx 4)
            const showMdArrow = idx === 0 || idx === 2 || idx === 4;
            // Mobile 1-col: vertical flow down between steps 01..05
            const showMobileArrow = idx < 5;

            return (
              <div key={idx} className="relative group/card-wrapper flex flex-col">
                <div
