...
export function Features() {
  return (
    <section id="features" className="py-24 border-t border-white/10 bg-[#060b19] text-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {FEATURE_CARDS.map((card, i) => (
            <Link
              key={i}
              href={card.href}
              className="bg-[#0b132b]/80 border border-white/10 rounded-2xl p-6 space-y-6 hover:shadow-[0_10px_30px_rgba(0,0,0,0.5)] hover:border-primary/50 transition-all duration-300 flex flex-col justify-between hover:-translate-y-1.5 group backdrop-blur-md"
            >
              ...
              <div className="pt-4 border-t border-white/5 flex items-center justify-between text-xs font-semibold text-blue-400 group-hover:text-cyan-300">
