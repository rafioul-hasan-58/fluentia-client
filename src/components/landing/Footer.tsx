...
export function Footer() {
  return (
    <footer className="bg-paper border-t border-slate-200 dark:border-white/10 pt-12 sm:pt-16 pb-10 sm:pb-12 text-ink transition-colors duration-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-10 pb-10 sm:pb-12 border-b border-slate-200 dark:border-white/10">
          {/* Brand Column */}
          <div className="md:col-span-4 space-y-3.5 sm:space-y-4">
            <Link href="/" className="inline-flex items-center gap-2.5 sm:gap-3 group">
              <div className="relative w-9 h-9 sm:w-11 sm:h-11 group-hover:scale-105 transition-transform duration-200">
                <Image
                  src="/logo.png"
                  alt="Fluentia Logo"
                  width={44}
          ...
          <div className="md:col-span-3 space-y-3">
            ...
            <ul className="space-y-2 text-xs font-medium text-ink-soft">
              ...
              <li>
                <Link href="/dashboard/user" className="hover:text-primary dark:hover:text-purple-300 transition-colors">
                  Learning Console
                </Link>
              </li>
              <li>
                <Link href="/dashboard/user/chat" className="hover:text-primary dark:hover:text-purple-300 transition-colors">
                  AI Practice Coach
                </Link>
              </li>
            </ul>
              ...
              <div className="relative z-10 flex flex-col sm:flex-row items-start sm:items-center gap-3.5 sm:gap-4">
                ...
                <div className="relative shrink-0">
                  ...
                  <span className="absolute -bottom-1 -right-1 flex h-3.5 w-3.5">
                    ...
                    <span className="relative inline-flex rounded-full h-3.5 w-3.5 bg-emerald-500 border-2 border-white dark:border-[#0f172a]" />
                  </span>
                </div>
                ...
                <div className="space-y-1 min-w-0 flex-1">
                  ...
                  <p className="text-[10px] sm:text-[11px] text-ink-soft truncate">
