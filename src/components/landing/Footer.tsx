    ...
    <footer className="bg-paper border-t border-ink/5 py-12">
      <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-6">
        ...
        <div className="flex items-center gap-6 text-xs font-medium text-ink-soft">
          <Link href="#features" className="hover:text-jade transition-colors">Features</Link>
          <Link href="#demo" className="hover:text-jade transition-colors">Demo</Link>
          <Link href="#cta" className="hover:text-jade transition-colors">Learning Console</Link>
        </div>
