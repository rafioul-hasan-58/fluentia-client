...
export function CallToAction() {
  return (
    <section id="cta" className="bg-primary-light/30 border-y border-primary/10 py-16">
      <div className="max-w-4xl mx-auto px-6 text-center space-y-6">
        ...
        <div>
          <a
            href="#demo"
            className="inline-flex items-center justify-center px-6 py-3 rounded-xl bg-primary hover:bg-primary-dark text-white font-semibold text-sm transition-all duration-200 shadow-md shadow-primary/15 hover:scale-[1.02]"
          >
