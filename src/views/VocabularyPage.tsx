...
export default function VocabularyPage() {
  ...
  return (
    <div className="space-y-8 pb-16">
      ...
      <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-indigo-900/90 via-purple-900/80 to-slate-900 p-8 border border-white/10 shadow-2xl text-white">
        ...
        <div className="relative z-10 flex flex-col md:flex-row md:items-center md:justify-between gap-6">
          ...
          <div className="flex flex-wrap items-center gap-3">
            <button
              ...
              className="inline-flex items-center gap-2.5 px-6 py-3.5 rounded-2xl bg-gradient-to-r from-indigo-500 via-purple-600 to-pink-500 hover:from-indigo-600 hover:via-purple-700 hover:to-pink-600 text-white font-bold shadow-lg shadow-purple-500/25 hover:shadow-purple-500/40 hover:scale-[1.02] active:scale-[0.98] transition-all duration-200 cursor-pointer"
            >
        ...
        <div className="mt-8 pt-6 border-t border-white/10 grid grid-cols-2 sm:grid-cols-4 gap-4">
          <div className="flex items-center gap-3 bg-white/5 rounded-2xl p-3.5 backdrop-blur-sm border border-white/5">
          ...
          <div className="flex items-center gap-3 bg-white/5 rounded-2xl p-3.5 backdrop-blur-sm border border-white/5">
            ...
            <div>
              <p className="text-xs text-slate-400 font-medium">Mastered (4★+)</p>
              <p className="text-xl font-bold text-white">{stats.masteredCount}</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3 bg-white/5 rounded-2xl p-3.5 backdrop-blur-sm border border-white/5">
            ...
            <div>
              <p className="text-xs text-slate-400 font-medium">Parts of Speech</p>
