          ...
          <div className="fixed inset-0 z-[99999] w-screen h-screen bg-slate-100/95 dark:bg-[#0c0a17]/95 backdrop-blur-md text-slate-900 dark:text-white flex flex-col overflow-hidden animate-in fade-in duration-200">
            ...
            <div className="flex-1 w-full overflow-y-auto p-4 sm:p-6 lg:p-10 space-y-6 max-w-5xl mx-auto">
              ...
              <div className="relative overflow-hidden rounded-3xl bg-white dark:bg-[#141226] border border-slate-200/90 dark:border-white/10 p-6 sm:p-8 shadow-sm space-y-5">
                ...
                {/* Main Story Title with Edit Action */}
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                  <h1 className="text-2xl sm:text-3xl lg:text-4xl font-extrabold text-slate-900 dark:text-white tracking-tight capitalize font-brand flex-1">
                    {activeStory.title || "Vocabulary Story"}
                  </h1>
                  <button
                    onClick={() => handleOpenEditTitle(activeStory)}
                    className="inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-50 hover:bg-amber-500 hover:text-white hover:border-amber-500 dark:bg-slate-800/80 dark:hover:bg-amber-500 dark:hover:border-amber-500 dark:hover:text-white text-xs font-bold text-slate-700 dark:text-slate-200 transition-all cursor-pointer shadow-2xs shrink-0 self-start sm:self-center"
                    title="Edit story title"
                  >
                    <Pencil className="w-3.5 h-3.5" />
        ...
        <div className="fixed inset-0 z-[100000] flex items-center justify-center p-4 bg-slate-950/75 backdrop-blur-xs animate-in fade-in duration-150">
          <div className="w-full max-w-md rounded-3xl bg-white dark:bg-[#141226] border border-amber-500/30 dark:border-white/10 p-6 space-y-5 shadow-2xl">
            <div className="flex items-center justify-between border-b border-slate-100 dark:border-slate-800/80 pb-3.5">
              ...
              <button
                onClick={() => setStoryToEditTitle(null)}
            ...
            <form onSubmit={handleSaveTitle} className="space-y-4">
              ...
              <div className="flex gap-3 pt-2">
                ...
                <button
                  type="submit"
                  disabled={isUpdatingTitle || !editedTitleInput.trim()}
